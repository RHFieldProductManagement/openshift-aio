At the time of writing, OpenShift Virtualization is available as both upstream (**KubeVirt**) and downstream releases. Since OpenShift 4.5, OpenShift Virtualization has been fully supported by Red Hat as a component of OpenShift itself.
