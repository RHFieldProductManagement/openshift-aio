At the time of writing, OpenShift Virtualization is available as both upstream (**KubeVirt**) and downstream releases. **With the release of version 4.9 OpenShift Virtualization**. OpenShift Virtualization is fully supported by Red Hat
